...
import { handleShowWarnModal, warnModalSelector } from "../../redux/warnModel/warnModelSlice";
...
const WarnModal = () => {
	...
	return (
		<Modal className="warn-modal" size="sm" aria-labelledby="contained-modal-title-vcenter" centered show={warnModelSelector.isShow} onHide={handleClose}>
			<Modal.Body>
				{/* Delete Oops Modal */}
					...
					<div className="warn-modal-box">
						...
						<div className="modal-text">
							...
							<div className="modal-btn">
								<button type="button" className="btn me-4" onClick={handleClose}>
									Try Again
								</button>
								<button
									type="button"
				...
				{warnModelSelector.modelType === "success" && (
					<div className="warn-modal-box">
						...
						<div className="modal-text">
							...
							<p>{warnModelSelector.modelMessage}</p>
							<div className="modal-btn">
								<button type="button" className="btn continue" onClick={handleClose}>
									Continue
								</button>
							</div>
						</div>
